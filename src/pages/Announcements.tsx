        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="space-y-4">
              {documents.map((doc, index) => <div key={doc.id} className="bg-card border border-border rounded-lg p-4 flex items-center justify-between gap-4 hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {doc.isNew && <span className="ml-2 bg-accent text-accent-foreground text-xs px-2 py-0.5 rounded font-semibold">
                          {language === "ms" ? "BARU" : "NEW"}
                        </span>}
                    </div>
                  </div>
                  {doc.url !== "#" && <Button variant="outline" size="sm" className="gap-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground shrink-0" asChild>
            ...
            <div className="mt-12">
              ...
              <div className="rounded-xl overflow-hidden border border-border shadow-sm">
                <img src={mapAGM} alt={language === "ms" ? "Lokasi AGM - Al-Araby Mathaam" : "AGM Location - Al-Araby Mathaam"} className="w-full h-auto" />
              </div>
              <p className="text-muted-foreground text-sm mt-3 text-center">
                {language === "ms" ? "Dewan MAPIM, Atas Restoran Al-Araby Mathaam Bandar Puteri Bangi" : "MAPIM Hall, Above Al-Araby Mathaam Restaurant Bandar Puteri Bangi"}
              </p>
            </div>
          </div>
        </section>
